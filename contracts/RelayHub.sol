    ...
    */
        ...
        returns (RelayCallStatus)
    {
        ...
        bytes32 preReturnValue;
        {
            ...
            (bool success, bytes memory retData) = recipient.call.gas(preRelayedCallMaxGas)(
                abi.encodeWithSelector(IRelayRecipient(recipient).preRelayedCall.selector,
        ...
        // Finally, postRelayedCall is executed, with the relayedCall execution's status.
        {
            ...
            (bool successPost,) = recipient.call.gas(postRelayedCallMaxGas)(transaction);
